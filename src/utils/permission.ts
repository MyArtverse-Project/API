...
export const checkModAbovePermissions = async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  if (data.role == Role.MODERATOR || data.role == Role.ADMIN || data.role == Role.DEVELOPER) {
