...
const forgotPassword = (url: string) => {
    return `
    <body style="background: #fff;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
    ...
    <table width="100%" border="0" cellspacing="20" cellpadding="0"
        ...
        <tr>
            <td align="center"
                style="padding: 0px 0px 10px 0px; font-size: 16px; line-height: 22px; font-family: Inter, Helvetica, Arial, sans-serif; color: #000;">
                If you did not request to reset your password, someone may be trying to access your account.
            </td>
        </tr>
    </table>
</body>
